...
import 'package:robotint/interfaces/connexion.dart';
...
class _RobotPageState  extends State<ThreePage > {
  @override
      ...
      return Scaffold(
        ...
        SafeArea(
          child: Padding(
            ...
            children: [
              Image.asset('assets/images/undraw_Flying_drone_u3r2 (1).png',
                         ...
                         Text('Bienvenur sur platforme qui vous premettra de controler votre drone et robot tout en profitant du haut debits de 5g',),
                          ...
                          InkWell(
                            ...
                            Align(
                              ...
                              child: Text('Commencer',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize:  20),)
                            ),
                            decoration: BoxDecoration(
