...
import 'package:robotint/interfaces/pageCarou/three.dart';
...
class _RobotPageState  extends State<SecondPage> {
  @override
        ...
        SafeArea(
          child: Padding(
            ...
            children: [
              ...
              Image.asset('assets/images/undraw_Artificial_intelligence_re_enpp (5).png',
                        ...
                        Row(
                         ...
                         Text('Bienvenur sur platforme qui vous premettra de controler votre drone et robot tout en profitant du haut debits de 5g',),
                          ...
                          InkWell(
                           ...
                           onTap: () {
                                Navigator.push(
                              context, MaterialPageRoute(builder: (context)=> ThreePage ()));
                         },
                        )
